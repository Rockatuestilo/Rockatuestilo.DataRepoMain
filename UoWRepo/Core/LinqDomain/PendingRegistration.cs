...
public class PendingRegistration : Linq2DbEntity, ITEntity
{
    ...
    [Column(Name = "Id1")] [NotNull] public string Id1 { get; set; }

    [Column(Name = "Id2")] [NotNull] public string Id2 { get; set; }

    [Column(Name = "Id3")] [NotNull] public string Id3 { get; set; }

    [Column(Name = "Id4")] [NotNull] public string Id4 { get; set; }

    [Column(Name = "EmailMd5")] [NotNull] public string EmailMd5 { get; set; }

    [Column(Name = "UserLoginNameMd5")]
    [NotNull]
